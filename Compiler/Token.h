...
#define ALL_LITERAL_MASK		(EMT_STRING_LITERAL | EMT_INTEGER_LITERAL | EMT_FLOAT_LITERAL)
#define REGISTERS_AND_LITERAL	0x000000CF
#define ALL_NUMBER_MASK			0x0000018B
#define PMC_TYPE_MASK			(PMC_INTEGER | PMC_FLOAT | PMC_STRING | PMC_LIST | PMC_HASHTABLE)
